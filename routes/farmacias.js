...
const farmaciaValidations = [
  ...
  body('latitud').isFloat({ min: -90, max: 90 }).withMessage('Latitud debe estar entre -90 y 90'),
  body('longitud')
...
router.post(
  '/',
  [authenticateToken, requireSuperUsuario, ...farmaciaValidations, validateRequest],
  createFarmacia
);
